public class Main {
    public static void main(String[] args) {
        ...
        order.addFlavor(repository.getFlavors().get(0)); // Mint Chocolate Chip
        order.addFlavor(repository.getFlavors().get(1)); // Chocolate Fudge
        order.addTopping(repository.getToppings().get(0)); // Sprinkles
        order.addTopping(repository.getToppings().get(1)); // Fresh Strawberries
